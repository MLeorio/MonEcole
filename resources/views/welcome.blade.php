...
<div class="container">
    ...
    <div class="row">
        ...
        <h1 class="title test">
            ...
            <br>
            <span class="st">
                Syst&egrave;me de gestion des notes de l'&eacute;cole
            </span>
        </h1>
                        ...
                        <div class="content">
                            <div class="main">
                                ...
                                <p class="text-center">Acc&egrave;s &agrave; la plate-forme des
                                    <span class="ex">Personnels</span> de l'&eacute;cole.</p>
                    ...
                    <div class="back">
                        ...
                        <div class="content">
                            <div class="main">
                                <h4 class="text-center">Mon &Eacute;cole</h4>
                                <p class="text-center">Acc&egrave;s &agrave; la plate-forme des
                                    <span class="ex">Professeurs</span> de l'&eacute;cole.</p>
                    ...
                    <div class="back">
                        ...
                        <div class="content">
                            <div class="main">
                                <h4 class="text-center">Mon &Eacute;cole</h4>
                                <p class="text-center">Acc&egrave;s &agrave; la plate-forme des
                                    <span class="ex">&Eacute;l&egrave;ves</span> de l'&eacute;cole.</p>
